...
You are responsible for keeping your password confidential and for all activity under your account. Information you provide (name, mobile number, date of birth, identity documents) must be accurate and belong to you. Commuter accounts require identity verification (government ID + selfie) before activation; driver accounts require license verification (license photos + selfie). Both are checked automatically first and cleared immediately on an obvious match; anything the automated check can't confidently confirm is reviewed by an admin. ManibelaApp may reject a submission or deactivate an account that fails verification or is later found to be fraudulent.
...
Commuters: full name, mobile number, date of birth (account creation); password, stored as a hash, never in plain text (account security); profile photo (personalization); government ID (type, front/back photo) and a selfie (identity verification before your account is activated — an automated system compares your selfie to your ID photo, and an admin reviews anything it can't confidently confirm); trip boarding/alighting records, rider count, ratings, complaints filed (operating and improving the jeepney tracking system); approximate location when requesting a ride ("demand signal") — processed as anonymized location clusters, never exposed with your identity attached.

Drivers: full name, mobile number, date of birth, plate number (account identification); profile photo (shown to commuters for driver recognition); driver's license front/back photo and a selfie, submitted by you from the app (verifying you are a licensed driver before your account is enabled — an automated system compares your selfie to your license photo, and an admin reviews anything it can't confidently confirm); live GPS location while a trip is active (real-time jeepney tracking, and trip-integrity review such as flagging abnormally short trips); daily operations log — odometer readings, earnings, expenses (your own self-reported records, visible to admins for operational review).
...
3. Legal Basis
We process your personal information based on your consent given at sign-up, and where necessary to perform our contract with you (providing the Service) or to comply with legal obligations. Government ID, license photos, and selfies are treated as sensitive personal information under RA 10173 and are collected only with your explicit consent, solely for identity and driver-eligibility verification. As part of that verification, an automated system compares your selfie against your ID or license photo — it can only clear an obvious match or defer to an admin for manual review, never reject an account on its own.
